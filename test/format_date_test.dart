...
void main() {
  ...
  test('format date testing', () {
    ...
    expect(FormatDate.formatDate(dateTime:dateTime, format: "dd-mm-yyyy"), "27-12-2023");
    expect(FormatDate.formatDate(dateTime:dateTime, format: "dd/mm/yyyy"), "27/12/2023");
    ...
    expect(FormatDate.formatDate(dateTime:dateTime, format: "dd-mm-yy"), "27-12-23");
    expect(FormatDate.formatDate(dateTime:dateTime, format: "dd/mm/yy"), "27/12/23");
    expect(FormatDate.formatDate(dateTime:dateTime, format: "mm-dd-yyyy"), "12-27-2023");
    expect(FormatDate.formatDate(dateTime:dateTime, format: "mm/dd/yyyy"), "12/27/2023");
    expect(FormatDate.formatDate(dateTime:dateTime, format: "mdy"), "Invalid Format");

  });

  test('format time testing', () {
    
    expect(FormatDate.formatTime(dateTime:dateTime, format: "hh-mm-ss"), "15-52-04");
    expect(FormatDate.formatTime(dateTime:dateTime, format: "hh:mm:ss"), "15:52:04");
